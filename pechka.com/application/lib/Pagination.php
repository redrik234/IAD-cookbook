...
class Pagination {
    ...
    private function generateHtml($page, $text = null) {
        ...
        return '<li class="page-item primary-color-dark rounded border border-dark"><a class="page-link text-white" href="/'.$this->route['controller'].'/'.$this->route['action'].'/'.$page.'">'.$text.'</a></li>';
    }
